...
public class Registro {
    ...
    public List<Datoscita> buscarTodos(){
        
        List<Datoscita> lista = new ArrayList<>();
        ...
        try {
            ...
            String query = "SELECT rut, nombre,apellido,telefono,edad,prevision,doctor,especialidad,fecha,valor FROM datoscita order by nombre";
            PreparedStatement stmt = cnx.prepareStatement(query);
